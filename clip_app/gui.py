...
def build_ui(self, args):
    ...
    # Create a label and slider for threshold control
    slider_label = Gtk.Label("Threshold:", valign=Gtk.Align.CENTER)
    ...
    # Pack the label and slider into a horizontal box and add it to the vertical box
    hbox = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=10)
    hbox.pack_start(slider_label, False, False, 0)
